    ...
    def _filter_and_convert_contours(self, contours, image_shape):
        ...
        for contour in contours:
            ...
            bounding_boxes.append({
                'class': 'palm_tree',  # Class name for palm tree
                'x': x_center * 100,  # Convert to percentage
                'y': y_center * 100,  # Convert to percentage
                'width': norm_width * 100,  # Convert to percentage
                'height': norm_height * 100,  # Convert to percentage
